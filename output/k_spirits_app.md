...
### File: app\api\admin\modifications\route.ts
```
...
### File: app\api\admin\spirits\route.ts
```
import { NextRequest, NextResponse } from 'next/server';
...
### File: app\api\admin\spirits\[id]\route.ts
```
import { NextRequest, NextResponse } from 'next/server';
import { revalidateTag } from 'next/cache';
import { db } from '@/lib/db';
...
### File: app\api\test-cache-sync\route.ts
```
import { NextResponse } from 'next/server';
import { newArrivalsDb } from '@/lib/db/firestore-rest';
 ...
 * Only removes from private cabinet; public reviews are kept independent.
 */
