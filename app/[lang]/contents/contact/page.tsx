                ...
                <div className="max-w-2xl mx-auto space-y-8 px-4">
                    ...
                    <section className="bg-card border border-border rounded-2xl p-6 sm:p-8">
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <h2 className="text-lg sm:text-xl font-black">{isEn ? 'Email' : '이메일'}</h2>
                        </div>
                        <p className="text-sm sm:text-base text-muted-foreground mb-4">
                            {isEn
                                ? 'For general inquiries, partnership opportunities, or technical support:'
                                : '일반 문의, 파트너십 기회 또는 기술 지원:'}
                        </p>
                        <a
                            href={isEn
                                ? "mailto:ruahn49@gmail.com?subject=K-Spirits Club Inquiry"
                                : "mailto:ruahn49@gmail.com?subject=K-Spirits Club 문의"}
                            className="inline-flex items-center gap-2 px-6 py-3 bg-amber-500 hover:bg-amber-600 text-white font-black rounded-xl transition shadow-lg hover:shadow-xl text-sm sm:text-base"
                        >
                        ...
                        <p className="text-xs sm:text-sm text-muted-foreground mt-4">
                            {isEn
                                ? 'We typically resolve within 1-2 business days.'
                    ...
                    <section className="bg-rose-500/5 border-2 border-rose-500/20 rounded-2xl p-6 sm:p-8">
                        ...
                        <div className="prose prose-sm sm:prose-base dark:prose-invert max-w-none">
                            <p className="text-foreground/90 leading-relaxed mb-4">
                                {isEn
                                    ? 'Found a mistake in our spirits database? Please let us know so we can correct it. When reporting, please include:'
                                    : '주류 데이터베이스에서 오류를 발견하셨나요? 수정할 수 있도록 알려주세요. 제보 시 다음 정보를 포함해주세요:'}
                            </p>
                            <ul className="list-disc list-inside space-y-2 text-foreground/80 mb-6 font-medium">
                        ...
                        <a
                            href="mailto:ruahn49@gmail.com?subject=Data Correction Request"
                            className="inline-flex items-center gap-2 px-6 py-3 bg-rose-500 hover:bg-rose-600 text-white font-black rounded-xl transition shadow-lg hover:shadow-xl text-sm sm:text-base"
                        >
                            <AlertTriangle className="w-4 h-4 sm:w-5 sm:h-5" />
                            {isEn ? 'Report Error' : '오류 제보하기'}
                        </a>
                    </section>
                    ...
                    <section className="bg-card border border-border rounded-2xl p-6 sm:p-8">
                        ...
                        <a
                            href="mailto:ruahn49@gmail.com?subject=Content Report"
                            className="inline-flex items-center gap-2 px-6 py-3 bg-blue-500 hover:bg-blue-600 text-white font-black rounded-xl transition shadow-lg hover:shadow-xl text-sm sm:text-base"
                        >
                            <MessageSquare className="w-4 h-4 sm:w-5 sm:h-5" />
                            {isEn ? 'Report Content' : '콘텐츠 신고'}
                        </a>
                    </section>
