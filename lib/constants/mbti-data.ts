...
export const MBTI_RESULTS: Record<MBTI_TYPE, MBTIResult> = {
    ...
    ENTJ: {
        ...
        description_ko: '부드러운 카리스마가 흐르는 리더! 목표를 향해 직진하는 당신의 모습은 언제나 우아하고 당당해요. 👑',
        description_en: 'A smooth yet powerful leader! You march toward your goals with elegance and undeniable confidence. 👑',
