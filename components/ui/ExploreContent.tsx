      ...
      <div className="flex flex-col md:flex-row justify-between items-center mb-10 gap-4">
        ...
        <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
          ...
          <select
            ...
            className="px-4 py-3 rounded-2xl bg-white border border-gray-200 outline-none focus:ring-2 focus:ring-indigo-500 min-w-[140px]"
          >
          ...
          <select
            ...
            className="px-4 py-3 rounded-2xl bg-white border border-gray-200 outline-none focus:ring-2 focus:ring-indigo-500 min-w-[140px] disabled:opacity-50 disabled:bg-gray-100"
          >
          ...
          <div className="relative w-full md:w-80">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3 rounded-2xl bg-white border border-gray-200 shadow-sm focus:ring-2 focus:ring-indigo-500 transition-all outline-none"
              value={searchTerm}
